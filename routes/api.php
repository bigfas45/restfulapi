...
Route::resource('categories.products', 'Category\CategoryProductController',['index']);
Route::resource('categories.sellers', 'Category\CategorySellerController',['index']);
Route::resource('categories.transactions', 'Category\CategoryTransactionController',['index']);
Route::resource('categories.buyers', 'Category\CategoryBuyerController',['index']);
...
Route::resource('sellers.transaction', 'Seller\SellerTransactionController',['only' =>['index', 'show']]);
